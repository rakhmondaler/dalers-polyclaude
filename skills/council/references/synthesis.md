...
**Барнум-проверка:** прежде чем объявить конвергенцию сильным сигналом, спроси себя — подойдёт ли этот вывод любому похожему вопросу того же домена? Мысленно подставь другого человека с другим вопросом из этого домена. Если вердикт переживает замену — это конвергенция низкой специфичности: совет ответил на жанр вопроса, а не на ситуацию. Понизь её вес и скажи об этом в отчёте прямо. Помни: голоса коррелированы (одна модель, один автор персон, общая онтология) — единогласие само по себе дешевле, чем выглядит.
...
Отдельно сведи **допущения голосов**: всё, что агенты пометили как «Допущение». Это карта того, чего совет не знал и что достроил сам. Если допущение неверно — зависящие от него выводы разваливаются; покажи эти связи.

**Сигнал скудных данных:** если 4+ перспектив оценили уверенность как Среднюю или Низкую, либо допущений в голосах больше, чем фактов в контексте — скажи в отчёте прямо: «Совет работал на скудных данных; вердикт опирается на типовые паттерны домена, а не на специфику ситуации. Чтобы получить точнее, дай: [конкретный список недостающего]».
